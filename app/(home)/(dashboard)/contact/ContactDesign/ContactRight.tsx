    ...
    <main className="text-center">
      <div className="z-10">
        ...
        <div className="socials flex flex-row justify-center gap-2">
          ...
          <Link
            href="https://www.linkedin.com/in/prathamesh-chougale/"
            target="_blank"
          >
            <LinkedInLogoIcon height={25} width={25} />
          </Link>
          <Link
            href="https://www.instagram.com/prathamesh_chougale_17/"
            target="_blank"
          >
            <InstagramLogoIcon height={25} width={25} />
          </Link>
          <Link
            href="https://discord.com/channels/@prathameshchougale"
            target="_blank"
          >
            <DiscordLogoIcon height={25} width={25} />
          </Link>
          <Link
            href="https://www.codechef.com/users/prathamesh1717"
            target="_blank"
          >
            <CodeIcon height={25} width={25} />
          </Link>
          <Link href="mailto:prathamesh17170@gmail.com" target="_blank">
            <ChatBubbleIcon height={25} width={25} />
          </Link>
          <Link href="https://twitter.com/Prathamesh_7717" target="_blank">
            <Twitter />
          </Link>
        </div>
      </div>
